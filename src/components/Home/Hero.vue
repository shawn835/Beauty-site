<template>
  <section class="hero">
    ...
    <div class="hero-content">
      <div class="badge">
        <span>
          <FontAwesomeIcon icon="check" class="check" /> Certified
          Technicians</span
        >
        <span>
          <FontAwesomeIcon icon="check" class="check" /> Sterilized Tools</span
        >
        <span>
          <FontAwesomeIcon icon="check" class="check" /> Service Available</span
        >
      </div>
      ...
      <p class="hero-subtitle">
        Manicure • Pedicure • Gel Polish • Nail Art • Luxury Treatments
      </p>
      ...
      <div class="trust-badges">
        ...
        <div class="trust-item">
          <span class="icon"><FontAwesomeIcon icon="bottle-droplet" /></span>
